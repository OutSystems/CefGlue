namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefLifeSpanHandler
    {
        ...
        /// additional details.
        /// </summary>
        // protected abstract int OnBeforePopup(cef_browser_t* browser, cef_frame_t* frame, int popup_id, cef_string_t* target_url, cef_string_t* target_frame_name, CefWindowOpenDisposition target_disposition, int user_gesture, cef_popup_features_t* popupFeatures, cef_window_info_t* windowInfo, cef_client_t** client, cef_browser_settings_t* settings, cef_dictionary_value_t** extra_info, int* no_javascript_access);
        
        private void on_before_popup_aborted(cef_life_span_handler_t* self, cef_browser_t* browser, int popup_id)
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefLifeSpanHandler.OnBeforePopupAborted
        }
        ...
        /// </summary>
        // protected abstract void OnBeforePopupAborted(cef_browser_t* browser, int popup_id);
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefLifeSpanHandler.OnBeforeDevToolsPopup
        }
        ...
        /// </summary>
        // protected abstract void OnBeforeDevToolsPopup(cef_browser_t* browser, cef_window_info_t* windowInfo, cef_client_t** client, cef_browser_settings_t* settings, cef_dictionary_value_t** extra_info, int* use_default_window);
