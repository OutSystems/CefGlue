...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefCompletionCallback
    {
        ...
        private cef_completion_callback_t.get_refct_delegate _ds2;
        ...
        protected CefCompletionCallback()
        {
            ...
            _ds2 = new cef_completion_callback_t.get_refct_delegate(get_refct);
        ...
        private int add_ref(cef_completion_callback_t* self)
        {
            lock (SyncRoot)
            {
                var result = ++_refct;
