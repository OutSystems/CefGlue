...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefEndTracingCallback
    {
        ...
        private cef_end_tracing_callback_t.get_refct_delegate _ds2;
        ...
        protected CefEndTracingCallback()
        {
            ...
            _ds2 = new cef_end_tracing_callback_t.get_refct_delegate(get_refct);
        ...
        private int add_ref(cef_end_tracing_callback_t* self)
        {
            lock (SyncRoot)
            {
                var result = ++_refct;
