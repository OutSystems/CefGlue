...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_life_span_handler_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int on_before_popup_delegate(cef_life_span_handler_t* self, cef_browser_t* parentBrowser, cef_popup_features_t* popupFeatures, cef_window_info_t* windowInfo, cef_string_t* url, cef_client_t** client, cef_browser_settings_t* settings);
