...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_scheme_registrar_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate int add_custom_scheme_delegate(cef_scheme_registrar_t* self, cef_string_t* scheme_name, int is_standard, int is_local, int is_display_isolated, int is_secure, int is_cors_enabled);
        ...
        public static int add_custom_scheme(cef_scheme_registrar_t* self, cef_string_t* scheme_name, int is_standard, int is_local, int is_display_isolated, int is_secure, int is_cors_enabled)
        {
            ...
            return d(self, scheme_name, is_standard, is_local, is_display_isolated, is_secure, is_cors_enabled);
        }
