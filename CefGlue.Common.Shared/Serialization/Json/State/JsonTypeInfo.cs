...
using TypeMemberInfoMap = System.Collections.Generic.IReadOnlyDictionary<string, Xilium.CefGlue.Common.Shared.Serialization.Json.State.TypeMemberInfo>;

namespace Xilium.CefGlue.Common.Shared.Serialization.Json.State
{
